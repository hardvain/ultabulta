        ...
        function ($stateProvider, $urlRouterProvider, MODULE_CONFIG) {
            ...
            $stateProvider
                ...
                .state('app.verbal.passages.list', {
                    url: '',
                    templateUrl: '/app/views/ui/passages/passage-list.html',
                    ...
                    resolve: {
                        ...
                        deps: load(['/app/scripts/controllers/passages/PassagesController.js', '/app/scripts/directives/range.js']).deps
                    }
                })
                .state('app.verbal.passages.show', {
                    url: '/:id',
                    templateUrl: '/app/views/ui/passages/passage.html',
                    controller: 'PassageController',
                    data: {title: 'Passage'},
                    resolve: {
                        passage: function (PassageService, $stateParams) {
                            return PassageService.getPassage($stateParams.id);
                        },
                        deps: load(['/app/scripts/controllers/passages/PassageController.js']).deps
                    }
                })
